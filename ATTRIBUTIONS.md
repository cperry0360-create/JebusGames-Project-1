...
multi-second audio stings (generated by `tools/mksfx.py`), the goblin voice
line, and all code.
...
| **Elijah** | **Voice actor.** Recorded the goblin's line, the one heard as the first enemy comes out of the arch (`sfx-goblin-spawn.wav`) | His own card in the AUDIO section |
